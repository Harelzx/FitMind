...
import { calculateWeightLossPlan, calculateAge } from '@/lib/calculations/weightLossAlgorithm'
...
export default function CompleteProfilePage() {
  ...
  // Form data for completing profile
    ...
    try {
      ...
      const { error: weightEntryError } = await supabase
        ...
        .insert({
          ...
          notes: 'משקל התחלה - השלמת פרופיל Google'
        })
